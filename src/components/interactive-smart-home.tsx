...
const devices: SmartDevice[] = [
  {
    ...
    product: "NEXO Control Cabinet 48M",
    description:
  ...
  },
  {
    ...
    compatibility: "KNX, Home Assistant, scenarii NEXO",
    status: "Poziție · 62%",
  ...
  },
  {
    ...
    zone: "Dormitor etaj",
    product: "NEXO Room Controller CO₂",
    description:
  ...
  },
  {
    ...
    compatibility: "Home Assistant, gateway NEXO, notificări mobile",
