    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="border-t border-[#e2e8e5] bg-[#102720] text-white">
        <div className="section grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div><p className="text-sm font-semibold">Contact</p><address className="mt-4 not-italic text-sm leading-7 text-white/60">București · România<br />Luni–Vineri, 09:00–18:00<br />contact@nexo.example</address></div>
        </div>
