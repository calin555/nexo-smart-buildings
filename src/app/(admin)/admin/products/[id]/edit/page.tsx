  ...
  return (
    <main className="min-w-0 space-y-6">
      <section>
        ...
        <h1 className="mt-2 text-3xl font-semibold">Editează echipamentul</h1>
        <p className="mt-2 text-slate">
          Modificările sunt folosite intern în kituri, compatibilități, estimări și oferte.
        </p>
      </section>
      <ProductForm
        action={action}
        ...
        defaults={{
          ...
          priceLei: (product.priceFrom / 100).toFixed(2),
          badge: product.badge ?? "",
